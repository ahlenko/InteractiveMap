    ...
    InteractiveMapTheme {
        Column (modifier = Modifier.fillMaxSize(),
            ...
            Row (verticalAlignment = Alignment.CenterVertically,
                ...
                Text(stringResource(id = R.string.distant), modifier = Modifier,
            ...
            Box(modifier = Modifier.fillMaxSize().weight(1f).padding(top = 10.dp)){
                Box(modifier = Modifier.align(Alignment.BottomStart).padding(bottom = 100.dp, start = 30.dp)
                    .fillMaxWidth(0.70f).fillMaxHeight(0.10f)){
                    Image(painter = painterResource(id = R.drawable.img_distant_switch),
                ...
                Box(modifier = Modifier.align(Alignment.BottomEnd).padding(bottom = 100.dp, end = 45.dp)
                    .fillMaxWidth(0.80f).fillMaxHeight(0.67f)){
                    Image(painter = painterResource(id = R.drawable.img_schedule_editor),
                ...
                Box(modifier = Modifier.align(Alignment.TopStart).padding(top = 35.dp, start = 25.dp)
                    .fillMaxWidth(0.69f).fillMaxHeight(0.41f)){
                    Image(painter = painterResource(id = R.drawable.img_lesson_editor),
                ...
                Box(modifier = Modifier.align(Alignment.TopEnd).padding(top = 28.dp, end = 10.dp)
                    .fillMaxWidth(0.703f).fillMaxHeight(0.08f)){
                    Image(painter = painterResource(id = R.drawable.img_schedule_bar),
            ...
            Column (modifier = Modifier.fillMaxHeight(0.42f),
                verticalArrangement = Arrangement.SpaceEvenly) {
                Text(stringResource(id = R.string.distant_description),
                    modifier = Modifier.padding(horizontal = 20.dp),
                    style = MaterialTheme.typography.headlineMedium.copy(
                        color = MaterialTheme.colorScheme.onBackground,
                        fontWeight = FontWeight.Light, textAlign = TextAlign.Center))
                Spacer(modifier = Modifier.height(20.dp))
                Text(stringResource(id = R.string.distant_description_full),
                    modifier = Modifier.padding(horizontal = 20.dp),
                ...
                Box(modifier = Modifier.height(60.dp).padding(horizontal = 20.dp).padding(bottom = 15.dp)
                    ...
                    DefaultButton(buttonColor = MaterialTheme.colorScheme.onBackground,
                        textString = stringResource(id = R.string.go_to_application), borderRadius,
