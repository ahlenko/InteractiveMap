...
val Typography = Typography(
    ...
    headlineMedium = TextStyle(fontFamily = Inter, fontSize = 16.sp),
    bodySmall = TextStyle(fontFamily = Inter, fontSize = 15.sp),
    headlineSmall = TextStyle(fontFamily = Inter, fontSize = 14.sp),
    titleSmall = TextStyle(fontFamily = Inter, fontSize = 13.sp),
    labelSmall = TextStyle(fontFamily = Inter, fontSize = 8.sp),
)