    ...
    InteractiveMapTheme {
        Column (modifier = Modifier.fillMaxSize(),
            ...
            Row (verticalAlignment = Alignment.CenterVertically,
                ...
                Text(
                    stringResource(id = R.string.translation), modifier = Modifier,
            ...
            Box(modifier = Modifier.fillMaxSize().weight(1f).padding(top = 10.dp)){
                Box(modifier = Modifier.align(Alignment.BottomEnd).padding(bottom = 115.dp, end = 34.dp)
                    .fillMaxWidth(0.73f).fillMaxHeight(0.11f)){
                    Image(painter = painterResource(id = R.drawable.img_user_block),
                        modifier = Modifier.rotate(5f).fillMaxSize()
                ...
                Box(modifier = Modifier.align(Alignment.CenterStart).padding(bottom = 80.dp, start = 35.dp)
                    .fillMaxWidth(0.76f).fillMaxHeight(0.58f)){
                    Image(painter = painterResource(id = R.drawable.img_map_sample),
                        modifier = Modifier.rotate(-15.96f).fillMaxSize()
                            .then(ShadowMaterial.CustomShadow.createModifier
                                (5.dp, MaterialTheme.colorScheme.tertiaryContainer))
                            .then(ShadowMaterial.CustomReShadow.createModifier
                                (5.dp, MaterialTheme.colorScheme.onTertiaryContainer)),
                ...
                Box(modifier = Modifier.align(Alignment.TopEnd).padding(top = 20.dp, end = 20.dp)
                    .fillMaxWidth(0.62f).fillMaxHeight(0.27f)){
                    Image(painter = painterResource(id = R.drawable.img_location_settings),
                        modifier = Modifier.rotate(9.58f).fillMaxSize()
                            .then(ShadowMaterial.CustomShadow.createModifier
                                (5.dp, MaterialTheme.colorScheme.tertiaryContainer))
                            .then(ShadowMaterial.CustomReShadow.createModifier
                                (5.dp, MaterialTheme.colorScheme.onTertiaryContainer)),
            ...
            Column (modifier = Modifier.fillMaxHeight(0.42f),
                verticalArrangement = Arrangement.SpaceEvenly) {
                Text(stringResource(id = R.string.translation_description),
                    modifier = Modifier.padding(horizontal = 20.dp),
                    style = MaterialTheme.typography.headlineMedium.copy(
                        color = MaterialTheme.colorScheme.onBackground,
                        fontWeight = FontWeight.Light, textAlign = TextAlign.Center))
                Spacer(modifier = Modifier.height(20.dp))
                Text(stringResource(id = R.string.translation_description_full),
                    modifier = Modifier.padding(horizontal = 20.dp),
                    style = MaterialTheme.typography.titleSmall.copy(
                        color = MaterialTheme.colorScheme.onPrimary,
                        fontWeight = FontWeight.Light, textAlign = TextAlign.Justify))
                Spacer(modifier = Modifier.weight(1f))
                Box(modifier = Modifier.height(60.dp).padding(horizontal = 20.dp).padding(bottom = 15.dp)
                    .then(ShadowMaterial.CustomShadow.createModifier
                    ...
                    DefaultButton(buttonColor = MaterialTheme.colorScheme.onBackground,
                        textString = stringResource(id = R.string.register_account), borderRadius,
